...
const appointmentrequest = (username,doctorname,appointmentDate,appointmentTime,reason,specialization) => {
	return `
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Appointment Request Received - CliniCall</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.07); overflow: hidden;">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 40px 30px; text-align: center;">
                            ...
                            <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-weight: 600; letter-spacing: -0.5px;">Appointment Request Received</h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 50px 40px;">
                            ...
                            <p style="color: #4a5568; font-size: 16px; line-height: 1.6; margin: 0 0 32px 0;">
                                Thank you for requesting an appointment through CliniCall. We've received your request and it's pending confirmation from the doctor.
                            </p>
                            
                            <!-- Appointment Details Box -->
                            <div style="background-color: #f7fafc; border-left: 4px solid #667eea; border-radius: 8px; padding: 24px; margin-bottom: 32px;">
                                <h3 style="color: #1a202c; font-size: 18px; margin: 0 0 20px 0; font-weight: 600;">Appointment Details</h3>
                                
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="padding: 8px 0;">
                                            <p style="color: #718096; font-size: 14px; margin: 0; font-weight: 600;">Doctor</p>
                                            <p style="color: #1a202c; font-size: 16px; margin: 4px 0 0 0;">${doctorname}</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px 0;">
                                            <p style="color: #718096; font-size: 14px; margin: 0; font-weight: 600;">Specialization</p>
                                            <p style="color: #1a202c; font-size: 16px; margin: 4px 0 0 0;">${specialization}</p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px 0;">
                                            <p style="color: #718096; font-size: 14px; margin: 0; font-weight: 600;">Date & Time</p>
                                    ...
                                    <tr>
                                        <td style="padding: 8px 0;">
                                            <p style="color: #718096; font-size: 14px; margin: 0; font-weight: 600;">Reason for Visit</p>
                            ...
                            <div style="text-align: center; margin-bottom: 32px;">
                                <span style="display: inline-block; background-color: #fef5e7; color: #d97706; padding: 10px 24px; border-radius: 20px; font-size: 14px; font-weight: 600;">
                            ...
                            <div style="background-color: #eff6ff; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
                                <p style="color: #1e40af; font-size: 15px; line-height: 1.6; margin: 0;">
                                    ...
                                    You'll receive an email notification once the doctor confirms your appointment. This typically happens within 24 hours.
                                </p>
                            </div>
                    ...
                    <tr>
                        <td style="background-color: #f7fafc; padding: 30px 40px; text-align: center; border-top: 1px solid #e2e8f0;">
                            <p style="color: #718096; font-size: 14px; margin: 0 0 12px 0;">
                                Need to cancel or reschedule? Contact us at <a href="mailto:support@clinicall.com" style="color: #667eea; text-decoration: none;">support@clinicall.com</a>
                            </p>
