...
function MiniNavbar() {
  ...
  const registerButtonElement = (
    <Link to="/register">
      <button className="px-4 py-2 text-xs border border-[#333] bg-[rgba(31,31,31,0.62)] text-gray-300 rounded-full hover:border-white/50 hover:text-white transition-colors duration-200">
        Register
      </button>
    </Link>
  );
                    ...
                    <div className="space-y-3">
                      <div className="relative">
                        <input
                          ...
                          className="w-full backdrop-blur-[1px] text-white border border-white/10 rounded-full py-3 px-5 focus:outline-none focus:border-white/30 text-center bg-transparent"
                          required
                        />
                      </div>
