    ...
    return (
        <section className="relative">
            ...
            <main className="overflow-x-hidden">
                    ...
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-72">
                        <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl md:text-6xl lg:mt-16 xl:text-7xl font-bold">Build 10x Faster with Clinicall</h1>
                                <p className="mt-8 max-w-2xl text-balance text-lg">Highly customizable components for building modern medical platforms with editorial precision.</p>
                ...
                <section className="bg-background pb-2 border-t dark:border-white/5">
                    <div className="group relative m-auto max-w-7xl px-6">
                        <div className="flex flex-col items-center md:flex-row">
                            <div className="md:max-w-44 md:border-r md:pr-6">
                                <p className="text-end text-sm text-muted-foreground">Powering the best medical teams</p>
                            </div>
    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto max-w-7xl rounded-3xl px-6 transition-all duration-300 lg:px-12', scrolled && 'bg-background/50 backdrop-blur-2xl border-b')}>
                    <motion.div
