            ...
            <div className="relative grid grid-cols-1 md:grid-cols-2 gap-20">
                            ...
                            {testimonials.map((testimonial, index) => (
                                ...
                                >
                                    <img
                                        ...
                                        draggable={false}
                                        className="h-full w-full rounded-3xl object-cover object-center shadow-md dark:shadow-gray-800"
                                    />
                                </motion.div>
                            ))}
                        </AnimatePresence>
                ...
                <div className="flex justify-between flex-col py-4">
                    ...
                    <div className="flex gap-4 pt-12 md:pt-0">
                        <button
                            onClick={handlePrev}
                            className="h-7 w-7 rounded-full bg-secondary flex items-center justify-center group/button dark:bg-zinc-800"
                        >
